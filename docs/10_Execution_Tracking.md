...
|-----|-----|-------|----------|--------------|
| 1 | Foundation | 🟨 In Progress | 98% | Hafta 1-4 |
...
| # | Görev | Durum | Atanan | Başlangıç | Bitiş | Notlar |
|---|-------|-------|--------|-----------|-------|--------|
| 10.1.1 | Domain entity tests | ⬜ | | | | |
| 10.1.2 | Service logic tests | ⬜ | | | | |
| 10.1.3 | Repository tests (in-memory DB) | ⬜ | | | | |
| 10.1.4 | Target: > 70% coverage | ⬜ | | | | |
