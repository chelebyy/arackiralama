...
- As of 18 May 2026, the local Docker 100-user concurrent-booking baseline is also verified after inventory seed expansion and overlap-retry stabilization in the reservation hold path.
