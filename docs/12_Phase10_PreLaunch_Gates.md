...
| 8 | **Load Tests** | Availability query p95 | < 300ms | 🟨 **LOCAL DOCKER SMOKE PARTIAL 17 May 2026** — availability-query is still pending; surrounding smoke support work for booking, payment, and mixed traffic passed locally after reservation/hold, online-payment flag, and smoke-mode admin-login adjustments. | 🟨 PARTIAL |
