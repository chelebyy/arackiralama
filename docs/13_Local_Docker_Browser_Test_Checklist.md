...
**Status:** COMPLETE LOCALLY — all eight workflow rows are closed against the rebuilt Docker stack. CI, Aikido, deployment/rollback rehearsal, and the production legacy-adapter observation window remain separate release gates.
