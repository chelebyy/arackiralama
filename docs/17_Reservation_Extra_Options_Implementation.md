...
- On the first `409`, keep customer/driver/payment-method state and perform one catalog/quote refresh. On a second conflict, stop automatic retries, show changed items, and require explicit customer confirmation.
