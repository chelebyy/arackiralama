...
Base: c563ddf
Head: 9c50c043342e578991730997d8b8a9531af432e5
...
## Diff Stat
```
 .../public-content/PublicContentManager.test.tsx   |  98 ++++++-
 .../admin/public-content/ContactContentEditor.tsx  | 306 +++++++++++++++++++++
...
+  updateAdminPublicContact,
 ...
 const adminContentFixture: AdminPublicContent = {
   ...
   pages: [
     {
@@ -32,57 +33,109 @@ const adminContentFixture: AdminPublicContent = {
...
@@ -124,20 +177,55 @@ describe("PublicContentPage", () => {
