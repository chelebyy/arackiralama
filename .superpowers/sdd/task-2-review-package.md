...
Head: 2233511727ead3517be2fe0cc174918f1fd9c7c5
...
```
 ...
 .../Services/PublicSiteSettingsService.cs          | 387 +++++++++++++++++----
 .../Services/PublicSiteSettingsServiceTests.cs     |  86 +++++
 3 files changed, 409 insertions(+), 67 deletions(-)
```
...
@@ -53,78 +53,183 @@ public sealed class PublicSiteSettingsService(IApplicationDbContext dbContext) :
...
+    }
     ...
     private async Task<PublicSiteSettings> GetOrCreateAsync(CancellationToken cancellationToken)
     {
         ...
         if (settings is not null)
         {
             ...
             {
@@ -141,63 +246,68 @@ public sealed class PublicSiteSettingsService(IApplicationDbContext dbContext) :
...
@@ -389,21 +499,22 @@ public sealed class PublicSiteSettingsService(IApplicationDbContext dbContext) :
...
@@ -467,20 +578,37 @@ public sealed class PublicSiteSettingsService(IApplicationDbContext dbContext) :
...
@@ -569,21 +697,24 @@ public sealed class PublicSiteSettingsService(IApplicationDbContext dbContext) :
...
@@ -597,23 +728,24 @@ public sealed class PublicSiteSettingsService(IApplicationDbContext dbContext) :
...
@@ -635,71 +767,177 @@ public sealed class PublicSiteSettingsService(IApplicationDbContext dbContext) :
...
@@ -798,11 +1036,28 @@ public sealed class PublicSiteSettingsService(IApplicationDbContext dbContext) :
             true,
             2,
             [
...
@@ -15,20 +15,106 @@ public sealed class PublicSiteSettingsServiceTests
     {
