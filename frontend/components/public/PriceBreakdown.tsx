    ...
    <div className="bg-white rounded-xl border border-slate-200 overflow-hidden">
      ...
      <div className="p-6 space-y-4">
        <div className="flex items-center justify-between">
          ...
          <span className="text-slate-900 font-medium">{dailyRate} {currency}/{t("day")}</span>
        </div>

        <div className="flex items-center justify-between">
          <span className="text-slate-600">{t("rentalPeriod")}</span>
          <span className="text-slate-900 font-medium">{days} {t("days")}</span>
        </div>

        <div className="flex items-center justify-between pt-2 border-t border-slate-100">
          <span className="text-slate-700 font-medium">{t("subtotal")}</span>
        ...
        {extras.length > 0 && (
          <>
            ...
            <div className="flex items-center justify-between pt-2 border-t border-slate-100">
              <span className="text-slate-700 font-medium">{t("extrasTotal")}</span>
        ...
        <div className="pt-4 border-t border-slate-100">
          <div className="flex items-start gap-3 p-3 bg-sky-50 rounded-lg">
            ...
            <div>
              <p className="text-sm font-medium text-sky-900">{t("whatsIncluded")}</p>
