...
import { Table, TableCategory } from "@/app/(admin)/dashboard/(auth)/apps/pos-system/store";

import { Button } from "@/components/ui/button";
import { RadioGroup, RadioGroupItem } from "@/components/ui/radio-group";
import { Tooltip, TooltipContent, TooltipProvider, TooltipTrigger } from "@/components/ui/tooltip";
import TableListItem from "@/app/(admin)/dashboard/(auth)/apps/pos-system/tables/components/table-list-item";
import AddTableDialog from "@/app/(admin)/dashboard/(auth)/apps/pos-system/tables/components/add-table-dialog";
