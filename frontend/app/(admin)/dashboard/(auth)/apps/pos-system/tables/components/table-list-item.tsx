...
import { useStore, Table } from "@/app/(admin)/dashboard/(auth)/apps/pos-system/store";
import {
  EnumTableStatus,
  EnumTableStatusColor
} from "@/app/(admin)/dashboard/(auth)/apps/pos-system/enums";

import { Badge } from "@/components/ui/badge";
import TableDetailDialog from "@/app/(admin)/dashboard/(auth)/apps/pos-system/tables/components/table-detail-dialog";
