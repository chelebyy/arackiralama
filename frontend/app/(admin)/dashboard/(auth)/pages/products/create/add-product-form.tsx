...
import { AddMediaFromUrl } from "@/app/(admin)/dashboard/(auth)/pages/products/create/add-media-from-url";
import AddNewCategory from "@/app/(admin)/dashboard/(auth)/pages/products/create/add-category";
